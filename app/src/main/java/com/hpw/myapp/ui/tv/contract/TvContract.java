...
public interface TvContract {
    ...
    //Other接口
    abstract class OtherPresenter extends CoreBasePresenter<OtherModel, OtherView> {
    ...
    //TvShow接口
    abstract class TvShowPresenter extends CoreBasePresenter<TvShowModel, TvShowView> {
